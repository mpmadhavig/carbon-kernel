...
package org.wso2.carbon.keystore.internal;
...
import org.wso2.carbon.keystore.KeyStoreServiceHolder;
import org.wso2.carbon.keystore.persistance.RegistryDataPersistenceManager;
import org.wso2.carbon.keystore.service.KeyStoreManagementService;
import org.wso2.carbon.keystore.service.KeyStoreManagementServiceImpl;
import org.wso2.carbon.keystore.util.KeyStoreMgtUtil;
import org.wso2.carbon.user.core.service.RealmService;
import org.wso2.carbon.utils.ConfigurationContextService;

@Component(
        name = "keystore.service.component",
        immediate = true
)
public class KeyStoreServiceComponent {

    private static final Log log = LogFactory.getLog(KeyStoreServiceComponent.class);
    ...
    protected void setConfigurationContextService(ConfigurationContextService contextService) {
        ...
        KeyStoreServiceHolder.setConfigurationContextService(contextService);
    }
    ...
    protected void setRealmService(RealmService realmService) {
        ...
        KeyStoreServiceHolder.setRealmService(realmService);
    }
    ...
    protected void unsetRealmService(RealmService realmService) {
        ...
        KeyStoreServiceHolder.setRealmService(null);
    }
