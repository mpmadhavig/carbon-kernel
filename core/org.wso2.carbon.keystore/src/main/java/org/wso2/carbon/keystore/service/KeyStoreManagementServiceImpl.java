...
import org.wso2.carbon.keystore.KeyStoreAdmin;
import org.wso2.carbon.keystore.constants.KeyStoreConstants;
import org.wso2.carbon.keystore.exception.KeyStoreException;
import org.wso2.carbon.keystore.exception.KeyStoreManagementClientException;
import org.wso2.carbon.keystore.exception.KeyStoreManagementException;
import org.wso2.carbon.keystore.exception.KeyStoreManagementServerException;
import org.wso2.carbon.keystore.model.CertData;
import org.wso2.carbon.keystore.model.CertDataDetail;
import org.wso2.carbon.keystore.model.KeyStoreData;
import org.wso2.carbon.keystore.util.KeyStoreMgtUtil;
...
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage.ERROR_CODE_ADD_CERTIFICATE;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage.ERROR_CODE_ALIAS_EXISTS;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage.ERROR_CODE_BAD_VALUE_FOR_FILTER;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage.ERROR_CODE_CANNOT_DELETE_TENANT_CERT;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage.ERROR_CODE_CERTIFICATE_EXISTS;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage.ERROR_CODE_DELETE_CERTIFICATE;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage.ERROR_CODE_EMPTY_ALIAS;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage.ERROR_CODE_INVALID_CERTIFICATE;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage.ERROR_CODE_RETRIEVE_CLIENT_TRUSTSTORE;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage.ERROR_CODE_RETRIEVE_CLIENT_TRUSTSTORE_CERTIFICATE;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage.ERROR_CODE_RETRIEVE_KEYSTORE;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage.ERROR_CODE_RETRIEVE_KEYSTORE_INFORMATION;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage.ERROR_CODE_UNSUPPORTED_FILTER_OPERATION;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage.ERROR_CODE_VALIDATE_CERTIFICATE;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.FILTER_FIELD_ALIAS;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.FILTER_OPERATION_CONTAINS;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.FILTER_OPERATION_ENDS_WITH;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.FILTER_OPERATION_EQUALS;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.FILTER_OPERATION_STARTS_WITH;
import static org.wso2.carbon.keystore.constants.KeyStoreConstants.KeyStoreMgtConstants.SERVER_TRUSTSTORE_FILE;
...
public class KeyStoreManagementServiceImpl implements KeyStoreManagementService {
    ...
    private KeyStoreManagementServerException handleServerException(
            KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage error, String data) {
    ...
    private static String includeData(KeyStoreConstants.KeyStoreMgtConstants.ErrorMessage error, String data) {
