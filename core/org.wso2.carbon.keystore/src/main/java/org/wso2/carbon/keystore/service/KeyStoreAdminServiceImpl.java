...
public class KeyStoreAdminServiceImpl extends AbstractAdmin implements KeyStoreAdminInterface {
    ...
    @Override
    public KeyStoreData[] getKeyStores() throws KeyStoreException {
    ...
    @Override
    public void removeCertFromStore(String alias, String keyStoreName) throws KeyStoreException {
        KeyStoreAdmin admin = new KeyStoreAdmin(CarbonContext.getThreadLocalCarbonContext().getTenantId());
        admin.removeCertFromStore(alias, keyStoreName);
    }

    public PaginatedKeyStoreData getPaginatedKeystoreInfo(String keyStoreName, int pageNumber) throws KeyStoreException {
        KeyStoreAdmin admin = new KeyStoreAdmin(CarbonContext.getThreadLocalCarbonContext().getTenantId());
